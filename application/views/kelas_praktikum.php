...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="<?php echo $content_class; ?>">
            <div style="background:#27ae60;color:#fff;padding:10px 20px;margin-bottom:20px;border-radius:4px;font-size:18px;font-weight:bold;"><i class="fa fa-list"></i> Daftar Kelas Praktikum</div>
            <div class="mb-3">
            ...
            <div style="margin-top:10px;color:#555;font-size:14px;">
                Menampilkan daftar Kelas Praktikum, untuk mengedit dan menghapus data klik tombol pada kolom pilihan.
            </div>
            <a href="<?php
