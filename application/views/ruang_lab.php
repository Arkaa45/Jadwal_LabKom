...
<head>
    <meta charset="UTF-8">
    <title>Daftar Ruang Laboratorium</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="<?php echo $content_class; ?>">
            ...
            <table class="table table-bordered table-striped" id="ruang-table">
                ...
                <tbody>
                <?php if (!empty($ruang)): $no=1; foreach ($ruang as $row): ?>
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= htmlspecialchars($row['nama_ruang']); ?></td>
                        <td><?= htmlspecialchars($row['lokasi']); ?></td>
                        <td>
                            <a href="<?php echo base_url('index.php/RuangLab/edit/' . $row['kode_ruang']); ?>" class="btn btn-warning btn-sm"><img src="<?php echo base_url('assets/img/edit.png'); ?>" alt="Edit" style="width:16px;height:16px;"></a>
                            <a href="<?php echo base_url('index.php/RuangLab/hapus/' . $row['kode_ruang']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?');"><img src="<?php echo base_url('assets/img/trash.png'); ?>" alt="Hapus" style="width:16px;height:16px;"></a>
                        </td>
                    </tr>
                <?php endforeach; else: ?>
