...
<head>
    <meta charset="UTF-8">
    <title>Edit Ruang Laboratorium</title>
    ...
    <div class="row">
        ...
        <div class="<?php echo $content_class; ?>">
            <div style="background:#27ae60;color:#fff;padding:10px 20px;margin-bottom:20px;border-radius:4px;font-size:18px;font-weight:bold;">
                <i class="fa fa-edit"></i> Edit Ruang Laboratorium
            </div>
            <form action="<?php echo base_url('index.php/RuangLab/update/' . $ruang['kode_ruang']); ?>" method="post">
                <div class="form-group">
                    <label for="kode_ruang">Kode Ruang</label>
                    <input type="text" class="form-control" id="kode_ruang" name="kode_ruang" value="<?php echo htmlspecialchars($ruang['kode_ruang']); ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="nama_ruang">Nama Ruang</label>
                    <input type="text" class="form-control" id="nama_ruang" name="nama_ruang" value="<?php echo htmlspecialchars($ruang['nama_ruang']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="lokasi">Lokasi</label>
                    <input type="text" class="form-control" id="lokasi" name="lokasi" value="<?php echo htmlspecialchars($ruang['lokasi']); ?>" required>
                </div>
