...
<head>
    <meta charset="UTF-8">
    <title>Tambah Asisten Praktikum</title>
    ...
    <div class="row">
        ...
        <div class="<?php echo $content_class; ?>">
            <div style="background:#8e44ad;color:#fff;padding:10px 20px;margin-bottom:20px;border-radius:4px;font-size:18px;font-weight:bold;">
                <i class="fa fa-plus"></i> Tambah Asisten Praktikum
            </div>
            <form action="<?php echo base_url('index.php/AsistenPraktikum/simpan'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" placeholder="Nama Asisten Praktikum" required>
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat Asisten Praktikum" required>
                </div>
                <div class="form-group">
                    <label for="tgl_lahir">Tanggal Lahir</label>
                    <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" placeholder="hh/bb/yyyy" required>
                </div>
                <div class="form-group">
